...
exports.prepareIT = exports.decryptValue = exports.sign = exports.importRSAPrivateKey = exports.decryptRSAMessage = exports.generateRSAKeyPair = void 0;
...
async function decryptRSAMessage(privateKey, encryptedData) {
    return await crypto.subtle.decrypt({
        name: "RSA-OAEP"
    }, privateKey, encryptedData);
}
exports.decryptRSAMessage = decryptRSAMessage;
...
exports.sign = sign;
function encryptWithAESKey(key, plaintext) {
...
function decryptWithAESKey(key, r, ciphertext) {
    const blockSize = 16; // 128 bits
    const keyBytes = CryptoJS.enc.Hex.parse(key);
...
async function prepareIT(plaintext, walletAddress, walletPrivateKey, userKey, contractAddress, functionSelector) {
    ...
    const message = (0, ethers_1.solidityPackedKeccak256)(["address", "address", "bytes4", "uint256"], [walletAddress, contractAddress, functionSelector, BigInt("0x" + ct)]);
