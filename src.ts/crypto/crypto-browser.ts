...
export function encryptAES(plaintext: Uint8Array, key: Uint8Array): { ciphertext: string, r: string } {
...
export function decryptAES(ciphertext: Uint8Array, key: Uint8Array, r: Uint8Array): Uint8Array {
  const blockSize = 16; // 128 bits
