...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.soda = {}, global.CryptoJS));
    ...
    function signRawMessage(message, walletSigningKey) {
        ...
        const key = new SigningKey(walletSigningKey);
    ...
    function prepareMessage(plaintext, signerAddress, aesKey, contractAddress, functionSelector) {
        ...
        if (typeof contractAddress !== "string" || !isAddress(signerAddress)) {
        ...
        const messageHash = solidityPackedKeccak256(["address", "address", "bytes4", "uint256"], [signerAddress, contractAddress, functionSelector, BigInt("0x" + ct)]);
